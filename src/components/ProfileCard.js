...
import avtar from "../images/shakil-dp.jpg";
import card_bg from "../images/bg-pattern-card.svg";

function ProfileCard(props) {
  return (
    <div className="card-component">
      <header style={{ backgroundImage: `url(${card_bg})` }}>
        <img src={avtar} alt={props.name} />
      </header>
